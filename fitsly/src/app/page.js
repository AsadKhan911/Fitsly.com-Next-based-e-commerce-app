...
export const metadata = {
  title: 'Fitsly e-commerce app',
  description: 'Fitsly.com - Wear the code',
};
...
export default function Home() {
  return (
    <div>
      <div>
        <Image src="/images/home.jpg" alt="Home Image" width={1900} height={400} />
      </div>

      <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear the code with - Fitsly.com</h1>
