...
const Navbar = () => {
    ...
    return (
        <div className='flex flex-col md:flex-row md:justify-start justify-between items-center py-2 shadow-xl'>
            ...
            <div ref={ref} className="w-72 h-full sidebar absolute right-0 top-0 bg-pink-100 px-8 py-10 transform transition-transform translate-x-full">
                ...
                <button className="flex mx-auto mt-16 text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-600 rounded text-xl"><BsFillBagCheckFill className='m-0.5 mx-1 text-xl'/> Checkout</button>
            </div>
        </div>
    )
}
