            ...
            <form className="mt-12 space-y-6">
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="username" type="text" required className="w-full text-slate-900 text-sm border border-slate-300 px-4 py-3 pr-8 rounded-md outline-pink-600" placeholder="Enter user name" />
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <Link href={'/forgot'} className='"text-pink-600 hover:underline font-semibold"'><div className="text-sm">                  
